$(function() {
    ...
    // Gradients
    var gradientDesktop = ctx.createLinearGradient(0, 0, 0, 300);
    gradientDesktop.addColorStop(0, '#6078ea');
    gradientDesktop.addColorStop(1, '#17c5ea');

    var gradientMobile = ctx.createLinearGradient(0, 0, 0, 300);
    gradientMobile.addColorStop(0, '#ff8359');
    gradientMobile.addColorStop(1, '#ffdf40');
    ...
    var myChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [] // will be filled by functions
        },
        options: {
    ...
    function showAll() {
        myChart.data.datasets = [{
                ...
                backgroundColor: gradientDesktop,
                borderRadius: 20
            },
            {
                label: 'Mobile',
